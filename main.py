...
file=r"F:\TMOK 2023-04"      # 進行處裡的資料夾
name="mad202304.xlsx"        # mad儲存檔案的檔名
name2="patd202304.xlsx"      # patd儲存檔案的檔名
name3="chr_patd202304.xlsx"  # chr_patd儲存檔案的檔名

#

import AIS.mad  
file2=AIS.mad.avperm(file,name)  #將經過時間碼標記的原始資料轉變為個小時每分鐘平均封包數的資料，並回傳檔名
AIS.mad.graph(file2)    #利用該資料繪製成MAD


import AIS.patd  
file3=AIS.patd.chose(file2,name2)#在MAD資料中以特定算法標記出封包數較多的時間產生EXCEL檔並回傳檔名


import AIS.chr_patd
file4=AIS.chr_patd.chr(file3,name3)#將PATD檔加入琪合規則產生新的EXCEL檔並回傳檔名
